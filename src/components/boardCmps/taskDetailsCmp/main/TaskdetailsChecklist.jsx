...
const TaskChecklist = () => {
  ...
  return (
    <div style={{ padding: "16px",  }}> {/* More to top */}
      <section>
        <div style={{ position: "relative", marginLeft: "-32px" }}> {/* More to left */}
          <div
            style={{
              display: "flex",
          ...
          >
            <div style={{ display: "flex", alignItems: "center" }}>
              ...
              <div style={{ fontWeight: "bold", fontSize: "14px", color: "#42526e", marginBottom: "12px" }}>
                Checklist
              </div>
            </div>
            <div style={{ display: "flex", alignItems: "center" }}>
          ...
          <div style={{ display: "flex", alignItems: "center", justifyContent: "flex-start", marginTop: "8px" }}>
            <div style={{ marginRight: "8px" }}>{completionPercentage.toFixed(0)}%</div>
            <div
              style={{
                width: "100%",
                height: "5px",
        ...
        {visibleItems.map((item) => (
          <div
            key={item.id}
            style={{ display: "flex", alignItems: "center", marginTop: "8px", marginLeft: "-32px" }} // More to left
          >
            <input
              type="checkbox"
              checked={item.isDone}
