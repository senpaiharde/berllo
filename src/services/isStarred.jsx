...
export default function StarButton({ boardId, initialIsStarred, onToggle ,height='24',width='24'}) {
      ...
      >
        {isStarred ? (
          <span className="IstarredInside">
            ...
            >
              <svg width={width} height={height} viewBox="0 0 24 24" className="IstarredInsideSvg">
               <path
